...
def main():
    ...
    print("Ejemplo de consulta compleja:")
    print('"Desanidar Devices y ServicePoints, agrupar por fecha, deviceId y branchCode con suma de Total, crear campo reg con formato concatenado, ordenar por deviceId"')
